...
class PairedDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        input_img = self.data[img_id]["render"]
        output_img = self.data[img_id]["gt"]
        ref_img = self.data[img_id]["ref"] if "ref" in self.data[img_id] else None
        caption = self.data[img_id]["prompt"] if "prompt" in self.data[img_id] else "remove degradation"
