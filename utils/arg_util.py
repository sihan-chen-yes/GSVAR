...
class Args(Tap):
    ...
    # randomly rm ref
    use_ref_drop: bool = False

    # whether consider ref view loss
    use_ref_view_loss: bool = False

    # fusion block
    fusion_block_idx: List[int] = [i for i in range(24)]
...
def get_args(default=False):
    ...
    args.eval_freq = args.eval_freq // args.bs
